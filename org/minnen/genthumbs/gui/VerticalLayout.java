...
/**
 * A layout manager that positions components vertically and forces each component to have the maximum width.
 */
public class VerticalLayout implements LayoutManager
{
  ...
  /**
   * Construct a vertical layout with no constraints
   */
  public VerticalLayout()
  {}

  /**
   * Construct a vertical layout with the given width
   */
  ...
  /**
   * Construct a vertical layout with the given width and vertical gap
   */
  ...
  /**
   * Construct a vertical layout with the given minimum and maximum width along with th egiven vertical gap
   */
  ...
  public void layoutContainer(Container parent)
  {
    ...
    for (int i = 0; i < comps.length; i++) {
      ...
      if (prefd == null) prefd = new Dimension(100, 32); // TODO
